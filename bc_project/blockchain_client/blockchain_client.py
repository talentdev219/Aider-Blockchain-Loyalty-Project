...
class Transaction:
    ...
    def __init__(self, sender_address, sender_private_key, sender_ID, question, answer):
...
def new_wallet():
    ...
    with open('master-private.pem', 'w') as f:
        f.write(binascii.hexlify(private_key.exportKey(format='DER')).decode('ascii'))

    public_key = private_key.publickey()
    with open('master-public.pem', 'w') as f:
        f.write(binascii.hexlify(public_key.exportKey(format='DER')).decode('ascii'))
...
def generate_transaction():
	...
	transaction = Transaction(sender_address, sender_private_key, sender_ID, question, answer)
